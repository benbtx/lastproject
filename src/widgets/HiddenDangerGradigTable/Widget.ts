...
export = HiddenDangerGradigTable;

class HiddenDangerGradigTable extends BaseWidget {
    baseClass = "widget-hiddendangergradigtable";
    ...
    initHtml() {
        ...
        this.setHtml(html);
        this.ready();
        this.getHiddenDangerGradigTable(this.config.pagenumber);
    }
    ...
    getHiddenDangerGradigTableListCallback(results) {
        var that = this;
        if (results.code != 1) {
    ...
    initEvent() {
                ...
                success: function (result) {
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            //验证
                            (<any>$('#hiddendangergradigtable_addpopup')).bootstrapValidator();
                            Obj.submitObj.off("click").on("click", function () {
                                ...
                                $.ajax({
                                    ...
                                    type: "POST",
                                    url: AppX.appConfig.xjapiroot.replace(/\/+$/, "") + that.config.addHiddenDangerGradigTable,
                                    data: {
                                    ...
                                    success: this.addHiddenDangerGradigTableCallback.bind(this),
                                    error: function (data) {
                ...
                success: function (result) {
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            //验证
                            (<any>$('#hiddendangergradigtable_updatepopup')).bootstrapValidator();
                            ...
                            Obj.submitObj.off("click").on("click", function () {
                                ...
                                $.ajax({
                                    ...
                                    type: "POST",
                                    url: AppX.appConfig.xjapiroot.replace(/\/+$/, "") + that.config.updateHiddenDangerGradigTable,
                                    data: {
                                        "id": that.id,
                                        "trouble_type_id": trouble_type_id.val(),
                                        "content": content.val(),
                                    ...
                                    success: that.updateHiddenDangerGradigTableCallback.bind(this),
                                    error: function (data) {
        ...
        this.domObj.find('.btn_delete').on("click", function () {
            ...
            Obj.submitObj.off("click").on("click", function () {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    url: AppX.appConfig.xjapiroot.replace(/\/+$/, "") + this.config.deleteHiddenDangerGradigTable + this.id,
                    data: {
                        "id": this.id,
                        // f: "pjson"
                    },
                    success: this.deleteHiddenDangerGradigTableCallback.bind(this),
                    error: function (data) {
                        this.toast.Show("服务端ajax出错，获取数据失败!");
                    }.bind(this),
                    dataType: "json",
        ...
        this.domObj.find(".pre").off("click").on("click", function () {
            if (this.currentpage - 1 > 0) {
                ...
                this.getHiddenDangerGradigTable(this.currentpage);
    ...
    getHiddenDangerGradigTable(pagenumber) {
        ...
        $.ajax({
            ...
            success: this.getHiddenDangerGradigTableListCallback.bind(this),
            error: function (data) {
                this.toast.Show("服务端ajax出错，获取数据失败!");
            }.bind(this),
            dataType: "json",
    ...
    addHiddenDangerGradigTableCallback(results) {
    ...
    updateHiddenDangerGradigTableCallback(results) {
    ...
    deleteHiddenDangerGradigTableCallback(results) {
    ...
    getDeviceTypeListCallback(results) {
        ...
        var devicetype = this.popup.domObj.find(".devicetype").empty();
        ...
        devicetype.val(this.sys_device_type_id);
