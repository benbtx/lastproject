...
// Source: https://raw.githubusercontent.com/Esri/jsapi-resources/64abeb4/3.x/typescript/arcgis-js-api.d.ts
declare module "esri" {
...
declare module "extras/ClusterLayer" {
  import SpatialReference = require("esri/SpatialReference");
  ...
  class ClusterLayer extends IClusterLayer {
    constructor(options: IClusterLayer);
  }
  export = ClusterLayer;
}
